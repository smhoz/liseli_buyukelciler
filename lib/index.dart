...
export '/pages/authentication/create_account/create_account_widget.dart' show CreateAccountWidget;
...
export 'package:sosyal_medya/pages/education_information/education_information_view.dart'
    show EducationInformationView;
...
export '/pages/post_details_page/post_details_page_widget.dart' show PostDetailsPageWidget;
export '/pages/story_details/story_details_widget.dart' show StoryDetailsWidget;
export '/pages/authentication/edit_settings/edit_settings_widget.dart' show EditSettingsWidget;
export '/pages/authentication/edit_user_profile/edit_user_profile_widget.dart'
    show EditUserProfileWidget;
export '/archive_pages/edit_dog_profile/edit_dog_profile_widget.dart' show EditDogProfileWidget;
...
export '/updated_chat/chat_2_details/chat2_details_widget.dart' show Chat2DetailsWidget;
...
export '/updated_chat/image_details/image_details_widget.dart' show ImageDetailsWidget;
export '/pages/admin/admin_features_widget.dart' show AdminFeaturesWidget;
export '/pages/admin/user_list_page/user_list_page_widget.dart' show UserListPageWidget;
