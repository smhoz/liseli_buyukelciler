...
import 'package:sosyal_medya/pages/education_information/view/education_information_create/education_information_create_viewmodel.dart';

class EducationInformationCreateView extends StatefulWidget {
  const EducationInformationCreateView({super.key});

  @override
  State<EducationInformationCreateView> createState() => _EducationInformationCreateViewState();
}

class _EducationInformationCreateViewState extends EducationInformationCreateViewModel {
  @override
                  ...
                  onPressed: () async {
                    if (scaffoldKey.currentState!.validate()) {
                      if (schoolNameTextController.text.isNotEmpty &&
                        ...
                        await FirebaseFirestore.instance.collection('education_year_change').add({
                          'id': null,
