...
import 'package:sosyal_medya/pages/engellenenler/engllenenler_view.dart';
import 'package:sosyal_medya/pages/turkey_education_information/turkey_education_information_view.dart';
...
class EditSettingsWidget extends StatefulWidget {
  const EditSettingsWidget({super.key, this.mainProfileUsersRecord});
...
class _EditSettingsWidgetState extends State<EditSettingsWidget> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    debugPrint("mainProfileUsersRecord photo url ${widget.mainProfileUsersRecord?.photoUrl}");
                ...
                children: [
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Padding(
                                      ...
                                      child: Text(
                                        'Ayarlarınızı aşağıda düzenleyin',
                  ...
                  ListView(
                    ...
                    children: [
                        ...
                        child: Container(
                          ...
                          child: Padding(
                            ...
                            child: InkWell(
                              ...
                              onTap: () async {
                                context.pushNamed(
                                  EditUserProfileWidget.routeName,
                                  extra: <String, dynamic>{
                                    "mainProfileUsersRecord": widget.mainProfileUsersRecord,
                                  },
                                );
                              },
                              child: Row(
                            ...
                            child: InkWell(
                              ...
                              onTap: () async {
                                Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                    builder: (context) => EducationInformationView(),
                                  ),
                                );
                              },
                              child: Row(
                      ...
                      // turkey educational information
                      Padding(
                        padding: EdgeInsetsDirectional.fromSTEB(0.0, 0.0, 0.0, 1.0),
                        child: Container(
                          width: MediaQuery.sizeOf(context).width * 1.0,
                            ...
                            child: InkWell(
                              ...
                              onTap: () async {
                                Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                    builder: (context) => TurkeyEducationInformationView(),
                                  ),
                                );
                              },
                              child: Row(
                            ...
                            child: InkWell(
                              ...
                              onTap: () async {
                                Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                    builder: (context) => WorkingLifeView(),
                                  ),
                                );
                              },
                              child: Row(
                                        ...
                                        Column(
                                          children: [
                                            ...
                                            Padding(
                                              ...
                                              child: Text(
                                                "Hesabı silmek istediğinize eminmisiniz?",
                                                textAlign: TextAlign.center,
                                                style: FlutterFlowTheme.of(context)
                                                    .titleMedium
                                                    .override(
                                            ...
                                            Padding(
                                              ...
                                              child: Text(
                                                "Hesabınız sildiğiniz zaman işleminiz geri alınamaz bunu kabul ediyormusunuz?",
                                                textAlign: TextAlign.center,
                                                style: FlutterFlowTheme.of(context)
                                                    .bodyMedium
                                                    .override(
                                                  ...
                                                  child: Row(
                                                    children: <Widget>[
                                                      ...
                                                      Flexible(
                                                        ...
                                                        child: GestureDetector(
                                                          onTap: () async {
                                                            // ÖNCE USER DE onayı false güncelle sonra bu kodu bastırsın.....
                            ...
                            child: InkWell(
                              ...
                              onTap: () async {
                                Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                    builder: (context) => EngllenenlerView(),
                                  ),
                                );
                              },
                              child: Row(
                    ...
                    child: Row(
                      ...
                      children: [
                        Align(
                          alignment: AlignmentDirectional(0.0, -1.0),
                          child: Padding(
                            padding: EdgeInsetsDirectional.fromSTEB(2.0, 24.0, 0.0, 12.0),
