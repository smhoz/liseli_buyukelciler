...
import 'package:sosyal_medya/pages/working_life/view/working_life_edit/working_life_edit_viewmodel.dart';

class WorkingLifeEditView extends StatefulWidget {
  const WorkingLifeEditView({
    super.key,
    required this.model,
  });

  final WorkingLifeModel model;

  @override
  State<WorkingLifeEditView> createState() => _WorkingLifeEditViewState();
}

class _WorkingLifeEditViewState extends WorkingLifeEditViewModel {
  @override
                    ...
                    if (scaffoldKey.currentState!.validate()) {
                      await FirebaseFirestore.instance
                        ...
                        await CodeNoahDialogs(context).showFlush(
                          ...
                          message: 'Çalışma Bilgisi Güncellendi',
                        );
                      }).catchError((err) {
                        print(err);
                        Navigator.pop(context);
