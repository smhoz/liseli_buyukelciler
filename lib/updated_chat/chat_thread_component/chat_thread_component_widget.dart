              ...
              stream: queryChatMessagesRecord(
                ...
                limit: 200,
                  ...
                  if (_model.listViewPreviousSnapshot != null &&
                      !const ListEquality(ChatMessagesRecordDocumentEquality()).equals(
                          listViewChatMessagesRecordList, _model.listViewPreviousSnapshot)) {
                    () async {
              ...
              builder: (context, snapshot) {
                ...
                if (listViewChatMessagesRecordList.isEmpty) {
                  return EmptyStateSimpleWidget(
                    ...
                    title: 'Mesaj Yok',
                    body: 'Bu sohbette henüz hiç mesaj göndermediniz.',
                  );
                }
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                // System chat warning banner
                if (widget.chatRef?.isSystemChat ?? false)
                  Container(
                    width: double.infinity,
                    ...
                    child: Row(
                      children: [
                        ...
                        Expanded(
                          child: Text(
                            'Bu bir sistem mesajıdır. Yanıtlayamazsınız.',
                    ...
                    child: Row(
                      ...
                      children: [
                        FlutterFlowIconButton(
                          ...
                          onPressed: (widget.chatRef?.isSystemChat ?? false)
                              ? null
                              : () async {
                              ...
                              Padding(
                                ...
                                child: Container(
                                  ...
                                  child: TextFormField(
                                    ...
                                    enabled: !(widget.chatRef?.isSystemChat ?? false),
                                    onFieldSubmitted: (_) async {
                                      ...
                                      _model.newChatCopy = ChatMessagesRecord.getDocumentFromData(
                                    ...
                                    decoration: InputDecoration(
                                      ...
                                      hintText: 'Buraya yazmaya başlayın...',
                                      ...
                                      contentPadding:
                                          EdgeInsetsDirectional.fromSTEB(16.0, 16.0, 56.0, 16.0),
                                    ),
