...
class UserPostsRecord extends FirestoreRecord {
  ...
  bool? _postIsActivity;
  bool get postIsActivity => _postIsActivity ?? false;
  bool hasPostIsActivity() => _postIsActivity != null;

  DocumentReference? _postCategory;
  DocumentReference? get postCategory => _postCategory;
  bool hasPostCategory() => _postCategory != null;

  bool? _postShow;
  bool get postShow => _postShow ?? false;
  bool hasPostShow() => _postShow != null;
  ...
  void _initializeFields() {
    ...
    _postIsActivity = snapshotData['postIsActivity'] as bool?;
    _postCategory = snapshotData['postCategory'] as DocumentReference?;
    _postShow = snapshotData['postShow'] as bool?;
  }
...
Map<String, dynamic> createUserPostsRecordData({
  ...
  bool? postOwner,
  bool? postIsActivity,
  DocumentReference? postCategory,
  bool? postShow,
}) {
...
class UserPostsRecordDocumentEquality implements Equality<UserPostsRecord> {
  ...
  bool equals(UserPostsRecord? e1, UserPostsRecord? e2) {
    ...
    return e1?.postPhoto == e2?.postPhoto &&
        ...
        e1?.postIsActivity == e2?.postIsActivity &&
        e1?.postCategory == e2?.postCategory &&
        e1?.postShow == e2?.postShow;
  }
